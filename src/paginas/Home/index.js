        ...
        <>
            <div className="home-apresentacao">
                <div className="limitar-container">
                    ...
                    <p>
                        Confira abaixo todas as especialidades odontológicas que
            ...
            <ul className="lista-sobre-aparelho limitar-container">
                ...
                <li>
                    ...
                    <p>
                        Muitas pessoas não conseguem nem usar fio dental devido
                        à posição da sua dentição. Contudo, a correção
                        possibilita o cuidado com a saúde bucal de forma bem
                        mais ampla.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        incomodam muitas pessoas. Usar aparelho nos dentes é uma
                        das formas mais eficientes para que esses problemas
            ...
            <div className="home-depoimentos">
                ...
                <ul className="lista-depoimentos">
                    <li>
                        ...
                        <p>Alberto</p>
                        <p>
                            Usei aparelho por 2 anos e agora posso sorrir
                            novamente.
                        </p>
                    </li>
                    ...
                    <li>
                        ...
                        <p>Eliana</p>
                        <p>
                            Meus dentes eram espaçados e depois de 1 ano estão
                            no lugar certo.
                        </p>
                    </li>
                    ...
                    <li>
                        ...
                        <p>Carla</p>
                        <p>
                            Começei a usar ano passado e já estou notando a
                            diferença.
                        </p>
                    </li>
                </ul>
